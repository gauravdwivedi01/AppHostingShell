...
CLOUD_TEMPLATE_YAML="$SAX_INSTALLATION_DIR/conf/yaml/templates/azure-template/cloud-conf-template.yaml"
...
sed -ri 's|^(\s*)(url\s*:\s*"jdbc:hsqldb:hsql://localhost:9001/saxhsqldb"\s*$)|\1#url: '"jdbc:hsqldb:hsql://localhost:9001/saxhsqldb"'|' $YAML_FILE
